...
namespace ExcelChartsBlazorOpenxml.Services
{
    public interface IFitToConceptService
    {
        ...
        Task<List<MedicalTermsModel>> MedicalTermsData();

        Task<List<NonMedicalTermsModel>> NonMedicalTermsData();
        ...
        Task<Guid> SendDLLMergeRequest(ReportGenerationRequestDLL request);
